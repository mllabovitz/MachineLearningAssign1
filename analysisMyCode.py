...
def assess_portfolio(sd = dt.datetime(2008,1,1), ed = dt.datetime(2009,1,1), \
    ...
    # computing constant return equivalent
    # Not required just for fun
    yieldV = math.pow((daily_port_cr[-1]), (1.0/float(sf)))- 1.0 
